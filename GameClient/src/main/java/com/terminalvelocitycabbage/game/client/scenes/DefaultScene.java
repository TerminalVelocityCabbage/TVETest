...
public class DefaultScene extends Scene {
    ...
    public DefaultScene(Identifier renderGraph, Routine... routines) {
        ...
        addInputControllers(GameInput.UI_CLICK, GameInput.CLOSE_WINDOW_ON_ESCAPE, GameInput.MOVE_AROUND, GameInput.LOOK_AROUND, GameInput.SCROLL, GameInput.RELOAD_SHADERS, GameInput.PAUSE_SPINNING);
    }
