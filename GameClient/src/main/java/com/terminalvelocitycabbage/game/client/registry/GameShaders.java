...
public class GameShaders {
    ...
    public static void init(ResourceRegistrationEvent event) {
        TEST_VERTEX_SHADER = event.registerResource(GameResources.CLIENT_RESOURCE_SOURCE, ResourceCategory.SHADER, "default.vert").getIdentifier();
        TEST_FRAGMENT_SHADER = event.registerResource(GameResources.CLIENT_RESOURCE_SOURCE, ResourceCategory.SHADER, "default.frag").getIdentifier();
